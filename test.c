...
long double ltod(unsigned long long m_long){
...
{
    int exit;
    unsigned long long cbc_data_encrypt[200];
    unsigned long long cbc_data_dencrypt[200];
    unsigned long long ctr_data_encrypt[200];
    unsigned long long ctr_data_dencrypt[200];
    unsigned long long ecb_data_encrypt[200];
    unsigned long long ecb_data_dencrypt[200];
